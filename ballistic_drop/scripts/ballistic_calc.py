...
C_D = 0.05 # Missing
RHO = 1.293 # Missing
A = 0.05 # area exposed to direction of drop
M = 0.1133981 # payload mass (kg)
...
if __name__ == '__main__':  
    ...
    x_disp, y_disp, z_curr = bal_Calc(target_lat, target_long, V, true_course, z_loc, w_x, w_y, w_z)
